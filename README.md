# Данный проект был разработан в целях изучения/закрепления Spring Core, Spring MVC, JdbcTemplate
...
требуется.
10) На странице книги, если книга свободна, должен быть выпадающий список (<select>)
